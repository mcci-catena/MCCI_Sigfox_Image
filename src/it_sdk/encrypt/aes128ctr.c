...
#if ( ITSDK_SIGFOX_ENCRYPTION & __PAYLOAD_ENCRYPT_AESCTR ) > 0 || ( ITSDK_LORAWAN_ENCRYPTION & __PAYLOAD_ENCRYPT_AESCTR ) > 0 || ITSDK_WITH_SECURESTORE == __ENABLE || ITSDK_WITH_SIGFOX_LIB == __ENABLE
